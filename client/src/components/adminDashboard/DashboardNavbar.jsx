    ...
    return (
      ...
      <div className="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
        ...
        <div className="hidden sm:block">
          <label htmlFor="icon" className="sr-only text-white">Search</label>
          <div className="relative">
            ...
            <input type="text" id="icon" name="icon" className="py-2 px-4 pl-11 block w-full  border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-100 focus:ring-blue-100 bg-[#81abbc]  text-white" placeholder="Search"/>
          </div>
        </div>
        ...
        <div className="flex flex-row items-center justify-end gap-2">
          ...
          <button type="button" className="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium  text-gray-700 align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-xs bg-[#6189a2]   hover:bg-slate-800  text-white  hover:text-white  focus:ring-gray-700  " data-hs-offcanvas="#hs-offcanvas-right">
            <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className="hs-dropdown relative inline-flex [--placement:bottom-right]">
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem]  shadow-md rounded-lg p-2 bg-[#6189a2]   border  border-gray-700" aria-labelledby="hs-dropdown-with-header">
              <div className="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg  ">
                <p className="text-sm text-white0  text-white">Signed in as</p>
                <p className="text-sm font-medium text-gray-800  text-gray-300">james@site.com</p>
              </div>
